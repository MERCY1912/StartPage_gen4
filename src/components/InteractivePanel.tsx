...
const getServices = (): Service[] => [
  {
    id: 'style',
    icon: 'https://blog.femmify.me/wp-content/uploads/2025/08/style.png',
  ...
  {
    id: 'recipes',
    icon: 'https://blog.femmify.me/wp-content/uploads/2025/08/recepti.png',
    titleKey: 'Рецепты',
  ...
  {
    id: 'wellness',
    icon: 'https://blog.femmify.me/wp-content/uploads/2025/08/health.png',
  ...
  {
    id: 'relationships',
    icon: 'https://blog.femmify.me/wp-content/uploads/2025/08/love.png',
    titleKey: 'Отношения',
  ...
  {
    id: 'mood',
    icon: 'https://blog.femmify.me/wp-content/uploads/2025/08/ideas.png',
  ...
  {
    id: 'selfcare',
    icon: 'https://blog.femmify.me/wp-content/uploads/2025/08/yhod.png',
  ...
  {
    id: 'career',
    icon: 'https://blog.femmify.me/wp-content/uploads/2025/08/work.png',
  ...
  {
    id: 'hobbies',
    icon: 'https://blog.femmify.me/wp-content/uploads/2025/08/fun.png',
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="max-w-4xl mx-auto">
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className={`backdrop-blur-xl bg-white/50 border border-primary rounded-2xl p-4 sm:p-6 lg:p-8 relative overflow-hidden shadow-xl ${meowMode ? 'meow-mode-active' : ''}`}>
              {/* Мяу-режим огонек */}
              {meowMode && (
              ...
              <div className="space-y-4">
                ...
                <button
                  ...
                  className="relative w-full py-3 sm:py-4 px-4 sm:px-6 bg-gradient-to-r from-accent to-accent-vibrant text-white rounded-full font-medium text-base sm:text-lg disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 ease-in-out transform hover:-translate-y-0.5 shadow-lg hover:shadow-xl shadow-accent/40 flex items-center justify-center space-x-2 overflow-hidden group"
                >
          ...
          {(isLoading || result || selectedCards.length > 0) && (
            <div className="mt-6 sm:mt-8 bg-gray-100 border border-primary rounded-2xl p-4 sm:p-6 lg:p-8 shadow-lg shadow-primary/20">
